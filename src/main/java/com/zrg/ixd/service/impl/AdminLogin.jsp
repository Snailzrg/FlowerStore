...
<body>
    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <form class="content-wrap" action="adLogin" method="post">
                <h6>管理员 登录</h6>
                <input class="span12" type="text" name="aname" placeholder="E-mail address" />
                <input class="span12" type="password" name="apwd"  placeholder="Your password" />
